...
class AccmStageINR:
    def __init__(self, scalar_metric_names, vector_metric_names=(), vector_metric_lengths=(), device="cpu"):
        self.device = device
    ...
    def update(self, metrics_to_add, count=None, sync=False, distenv=None):
        ...
        metrics_to_add = {name: value for (name, value) in metrics_to_add.items() if value is not None}
