...
from models.generalizable_INR.configs import TransINRConfig, LowRankModulatedTransINRConfig
from models.generalizable_INR.configs import MetaLowRankModulatedINRConfig
from models.generalizable_INR_nerf.configs import TransINRNerfConfig, LowRankModulatedTransINRNerfConfig
...
def augment_arch_defaults(arch_config):
    ...
    elif arch_config.type == "transinr_nerf":
        arch_defaults = TransINRNerfConfig.create(arch_config)
    elif arch_config.type == "low_rank_modulated_transinr_nerf":
        arch_defaults = LowRankModulatedTransINRNerfConfig.create(arch_config)
...
def augment_defaults(config):
    ...
    if "inr" in config.arch.type:
        ...
        loss_defaults = OmegaConf.create({"loss": {"type": "mse", "subsample": subsample_defaults, "coord_noise": None}})
